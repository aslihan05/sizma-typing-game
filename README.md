...
Komutların uzunluk tavanı vardır — normal için `BALANCE.cmdMaxLen` (30),
boss için `bossMaxLen` (40). Tavan keyfî değil: satır ekranda ne kadar
kalıyorsa, komutu hedef hızda yazmak ondan kısa sürmelidir — yoksa kusursuz
oynayan biri için bile yetişilmesi imkânsız bir komut üretilmiş olur.
...
- **Komutlar yazılmıyor, üretiliyor.** Sabit liste ne kadar uzasa da torba bitince
  ...
  oradakiler seçilmiş ve kurguya oturmuş komutlar. Havuz 130 → 3548 (TR).
